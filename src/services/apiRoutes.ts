export const API_ROUTES = {
    ...
    CREATE_USER_REPORT: `/job-management/v1/userreports`,
    ...
    OCR_STATUS: (uuid: string) => `/job-management/v1/ocr/${uuid}`,
    UPDATE_INVOICE_DETAILS: `/job-management/v1/invoice-details`,
