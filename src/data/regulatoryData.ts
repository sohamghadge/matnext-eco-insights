...
const mockRegulatoryData: RegulatoryData = {
    ...
    regulations: [
        // --- EPR (Collection & Recycling) ---
        {
            id: 'reg-elv-steel',
            name: 'ELV Steel Collection & Recycling',
            formalName: 'Environment Protection (End-of-Life Vehicles) Rules, 2025',
            country: 'India',
            description: 'Mandates steel recovery from scrapped end-of-life vehicles under EPR framework.',
            status: 'In Progress',
            deadline: '2025-30',
            impact: 'High',
            quantitativeTarget: '8% (2025-30), 13% (2030-35), 18% (2035+)',
            quantitativeAchieved: '6.5%',
        },
        {
            id: 'reg-battery-collection',
            name: 'Battery Waste Management (EV)',
            formalName: 'Battery Waste Management Rules, 2022 (amended 2025)',
            country: 'India',
            description: 'EPR obligations for collection & recycling of Li, Co, Mn, Cu, Ni, Fe, Al, Pb, Cd, Zn and Lead Acid batteries.',
            status: 'In Progress',
            deadline: '2029 onwards',
            impact: 'High',
            quantitativeTarget: '70% (Li/Co/Mn/Cu/Ni/Fe/Al by 2029), 90% (Lead Acid by 2026)',
            quantitativeAchieved: '45% (Li-Ion), 92% (Lead Acid)',
        },
        {
            id: 'reg-plastic-cat1',
            name: 'Plastic Waste Mgmt – Category I',
            formalName: 'Plastic Waste Management Rules, 2016 (amended 2025)',
            country: 'India',
            description: 'EPR for collection & recycling of Category I plastic waste from automotive applications.',
            status: 'In Progress',
            deadline: '2027 Onwards',
            impact: 'High',
            quantitativeTarget: '50% (2024-25), 60% (2025-26), 70% (2026-27), 80% (2027+)',
            quantitativeAchieved: '52%',
        },
        {
            id: 'reg-plastic-cat23',
            name: 'Plastic Waste Mgmt – Category II, III',
            formalName: 'Plastic Waste Management Rules, 2016 (amended 2025)',
            country: 'India',
            description: 'EPR for collection & recycling of Category II/III plastic waste from automotive sector.',
            status: 'Non-Compliant',
            deadline: '2027 Onwards',
            impact: 'Medium',
            quantitativeTarget: '30% (2024-25), 40% (2025-26), 50% (2026-27), 60% (2027+)',
            quantitativeAchieved: '22%',
        },
        // --- EPR (Recycled Content) ---
        {
            id: 'reg-elv-recycled-steel',
            name: 'ELV Recycled Content (Steel)',
            formalName: 'Environment Protection (End-of-Life Vehicles) Rules, 2025',
            country: 'India',
            description: 'Mandates minimum recycled content in steel used for new vehicle manufacturing.',
            status: 'In Progress',
            deadline: '2027-28',
            impact: 'High',
            quantitativeTarget: '5% (2027-28), 10% (2028-29), 15% (2029-30), 20% (2030+)',
            quantitativeAchieved: 'Upcoming',
        },
        {
            id: 'reg-battery-recycled',
            name: 'Battery Recycled Content',
            formalName: 'Battery Waste Management Rules, 2022 (amended 2025)',
            country: 'India',
            description: 'Requires minimum recycled content in total dry weight of new batteries.',
            status: 'In Progress',
            deadline: '2027-28',
            impact: 'High',
            quantitativeTarget: '5% (2027-28), 10% (2028-29), 15% (2029-30), 20% (2030+)',
        ...
        {
            id: 'reg-plastic-recycled',
            name: 'Plastic Recycled Content',
            formalName: 'Plastic Waste Management Rules, 2016 (amended 2025)',
            country: 'India',
            description: 'Mandates use of recycled plastic content in new vehicle components.',
            status: 'In Progress',
            deadline: 'Upcoming',
            impact: 'Medium',
            quantitativeTarget: 'Upcoming',
            quantitativeAchieved: 'Upcoming',
        },
        {
            id: 'reg-eu-plastic-recycled',
            name: 'EU Recycled Content (Plastic)',
            formalName: 'EU ELV Regulation – Circularity Requirements (EU) 2018/858 amend.',
            country: 'EU',
            description: 'Requires 20% recycled plastic content (15% from ELV) in new vehicles sold in EU market.',
            status: 'In Progress',
            deadline: '2030',
            impact: 'High',
            quantitativeTarget: '20% (out of which 15% from ELV)',
            quantitativeAchieved: '12%',
        },
        // --- CBAM ---
        {
            id: 'reg-cbam',
            name: 'EU CBAM',
            formalName: 'Regulation (EU) 2023/956 – Carbon Border Adjustment Mechanism',
            country: 'EU',
            description: 'Carbon pricing mechanism for imports of carbon-intensive goods including steel, aluminium, and iron products.',
            status: 'In Progress',
            deadline: 'Jan 2026 (Financial), Jan 2028 (Auto)',
            impact: 'High',
            quantitativeTarget: 'Steel: ≤1.9 tCO2e/t, Al: ≤4.2 tCO2e/t',
            quantitativeAchieved: 'Steel: 1.85 avg, Al: 4.1 avg',
        },
        // --- Existing EU & India regulations ---
        {
            id: 'reg-elv-eu',
            name: 'ELV Directive 2000/53/EC',
            formalName: 'Directive 2000/53/EC on End-of-Life Vehicles',
            country: 'EU',
            description: 'Mandates 95% recoverability and 85% recyclability for all vehicles sold in EU.',
            status: 'Compliant',
            deadline: 'Ongoing',
            impact: 'High',
            quantitativeTarget: '95% Recovery, 85% Recycling',
            quantitativeAchieved: '96.2% Recovery, 87% Recycling',
        },
        {
            id: 'reg-ais129',
            ...
            country: 'India',
            description: 'Indian standard for collection, dismantling and recycling of end-of-life vehicles.',
            status: 'Compliant',
            deadline: 'Ongoing',
            impact: 'High',
    ...
    models: [
        ...
        },
        {
            ...
            image: 'https://imgd.aeplcdn.com/664x374/n/cw/ec/36003/dzire-exterior-right-front-three-quarter-2.jpeg?isig=0&q=80',
            complianceScore: 83,
            type: 'ICE',
            generation: 'Legacy',
            targetMarket: 'Domestic',
            metrics: { recyclability: 87, elvCompliance: true, hazardousSubstances: 'Compliant', recycledMaterials: 70 },
            eprRecovery: { target: 95, actual: 94.2, status: 'Warning' },
            eprRecycling: { target: 85, actual: 82.0, status: 'Non-Compliant' },
            partCountTotal: 2300,
            partCountSteel: 1550,
            partCountAl: 180,
            compliantPartCountSteel: 1480,
            compliantPartCountAl: 160,
            exportVehicleCount: 6000,
            volumePartCountSteel: 9300000,
            volumePartCompliantSteel: 8880000,
            volumePartCountAl: 1080000,
            volumePartCompliantAl: 960000,
            cbamReadiness: 70,
            cbamCalculation: 'Hybrid (Default + Actual)',
            cbamAmount: 220000,
            reductionDataMgmt: 3000,
            reductionSustainable: 8000,
        },
        // --- Additional New Model ---
        {
            id: 'xl6',
            name: 'Maruti Suzuki XL6',
            image: 'https://imgd.aeplcdn.com/664x374/n/cw/ec/107405/xl6-exterior-right-front-three-quarter-4.jpeg?isig=0&q=80',
            complianceScore: 89,
            type: 'ICE',
            generation: 'New',
            targetMarket: 'Domestic',
            metrics: { recyclability: 91, elvCompliance: true, hazardousSubstances: 'Compliant', recycledMaterials: 250 },
            eprRecovery: { target: 95, actual: 95.8, status: 'Compliant' },
            eprRecycling: { target: 85, actual: 85.5, status: 'Compliant' },
            partCountTotal: 2900,
            partCountSteel: 1350,
            partCountAl: 550,
            compliantPartCountSteel: 1300,
            compliantPartCountAl: 520,
            exportVehicleCount: 7000,
            volumePartCountSteel: 9450000,
            volumePartCompliantSteel: 9100000,
            volumePartCountAl: 3850000,
            volumePartCompliantAl: 3640000,
            cbamReadiness: 88,
            cbamCalculation: 'Actual Data',
            cbamAmount: 310000,
            reductionDataMgmt: 7000,
            reductionSustainable: 15000,
        },
    ],
    epr: [
        {
